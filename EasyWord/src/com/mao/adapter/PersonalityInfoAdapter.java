...
public class PersonalityInfoAdapter extends BaseAdapter{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(position == 0) {
			...
			ImageLoader.getInstance().displayImage(headIv, url);
	...
	private void setItemContent(int position, TextView leftTv, TextView rightTv) {
		switch (position) {
		case 1:
			leftTv.setText(mContext.getResources().getString(R.string.sex));
			rightTv.setText(data.getSex());
			break;
		case 2:
			leftTv.setText(mContext.getResources().getString(R.string.phone));
